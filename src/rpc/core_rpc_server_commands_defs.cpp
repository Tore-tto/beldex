...
// KV_SERIALIZE_MAP_CODE_BEGIN(GET_BANS::ban)
//   KV_SERIALIZE(host)
//   KV_SERIALIZE(ip)
...
// KV_SERIALIZE_MAP_CODE_BEGIN(GET_BANS::response)
//   KV_SERIALIZE(status)
//   KV_SERIALIZE(bans)
// KV_SERIALIZE_MAP_CODE_END()


// KV_SERIALIZE_MAP_CODE_BEGIN(SET_BANS::ban)
//   KV_SERIALIZE(host)
//   KV_SERIALIZE(ip)
//   KV_SERIALIZE(ban)
//   KV_SERIALIZE(seconds)
...
// KV_SERIALIZE_MAP_CODE_BEGIN(SET_BANS::request)
//   KV_SERIALIZE(bans)
// KV_SERIALIZE_MAP_CODE_END()
